...
export const MODULE_INTROS: Record<string, Omit<ModuleIntroProps, "moduleId">> = {
  ...
  "vault-protocol": {
    ...
    description: {
      en: "Shamir's Secret Sharing in action — split secrets into shards, distribute to trustees, reconstruct when needed.",
      de: "Shamir's Secret Sharing in Aktion — Geheimnisse in Shards aufteilen, an Treuhänder verteilen, bei Bedarf rekonstruieren.",
    },
    bullets: {
      en: [
        "Create encrypted vaults with configurable threshold",
        "Verify individual shards without exposing the secret",
        "Reconstruct secrets from minimum required shards",
        "Honeypot detection for unauthorized access attempts",
      ],
      de: [
        "Verschlüsselte Vaults mit konfigurierbarem Schwellenwert erstellen",
        "Einzelne Shards verifizieren ohne das Geheimnis preiszugeben",
        "Geheimnisse aus Mindestanzahl Shards rekonstruieren",
